...
export const SHAREABLE_FIELDS = [
  ...
  'startingBoneMod',
  // Side ('PREFIX' / 'SUFFIX' / null) of the pending bone, when the
  // user knows it. Tells the engine which side's hit pool to use
  // for the reveal.
  'startingBoneSide',
  // Symmetric: whether the desired/target item is allowed to end
  // with a pending unrevealed bone-mod. Engine relaxes the "no
  // pending bone at goal" check when set.
  'targetBoneMod',
  'targetEntries',
